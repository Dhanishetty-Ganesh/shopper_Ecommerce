...
import { ShopContext } from '../components/shopcontext'; // Importing ShopContext for accessing cart data
import { CiMail } from 'react-icons/ci'; // Importing mail icon
import { BiPhoneCall } from 'react-icons/bi'; // Importing phone call icon
import { BsSearch } from 'react-icons/bs'; // Importing search icon
import { VscAccount } from 'react-icons/vsc'; // Importing account icon
import { CgShoppingCart, CgProductHunt } from 'react-icons/cg'; // Importing shopping cart and product hunt icons
...
import { NavLink, useLocation } from 'react-router-dom'; // Importing NavLink and useLocation for dynamic routing
import compare from "../assets/images/compare.svg"; // Importing compare image
import wishlist from "../assets/images/wishlist.svg"; // Importing wishlist image
import user from "../assets/images/user.svg"; // Importing user image
...
const Header = () => {
    ...
    // Accessing cart data from context
    const { getTotalCartProducts } = useContext(ShopContext);
    // Getting total cart products count
                ...
                <div className="container-xxl">
                    <div className="row align-items-center m-0">
                        <div className="col-md-2 d-flex justify-content-center">
                            ...
                            <h1 className="logo-heading">Shopper</h1>
                            {/* Cart icon */}
                        ...
                        <div className="col-md-10 row col-lg-10">
                            <div className="col-md-3 m-auto">
                                ...
                                <div className="input-group d-none d-md-flex">
                                    ...
                                    <button className="input-group-text" id="basic-addon2"><BsSearch /></button>
                                </div>
                            </div>
                            ...
                            <div className="col-md-3">
                                {/* Icons for comparison, wishlist, and account */}
